		...
		<div id="mainBg">
			<div id="mainPanel">
				...
				<div id="right">
					...
					<form name="loginForm" action="Users_login_success.jsp" method="post">
					<!-- start of login form -->
					<div id="welcome">
					...
					<div id="user-password">
						...
						<span class="input"><input type="password" name="upw" class="form-input"></span>
					</div>
					<div id="button-group">
